...
<section>
    ...
    <div class="half d-md-flex d-block">
        ...
        <div class="text text-center element-animate">
            ...
            <p><a href="{{route('breed.show', ['alias' => $dog->breed])}}" class="btn btn-primary btn-sm">Learn More</a></p>
        </div>
    </div>
    @endforeach
</section>
                    ...
                    @foreach($people as $person)
                        <div>
                            <div class="media d-block media-custom text-center">
                                <a href="{{route('people.show', ['alias' => $person->name])}}"><img src="{{asset(env('THEME'))}}/img/{{$person->img}}" alt="Image Placeholder" class="img-fluid"></a>
